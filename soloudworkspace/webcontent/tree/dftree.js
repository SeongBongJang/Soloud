 ...
 *    Vinicius Cubas Brand, Raphael Derosso Pereira, Frank Alcantara, Beno� VAN BOGAERT (as Macq Electronique sub-contractor)
...
function dNode(arrayProps) {
	...
	this.onClick = function(caption)
	{
		document.write(caption);
	};
	//javascript to execute onclick
