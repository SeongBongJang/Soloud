...
var selectedFolder3='';
	$(document).ready(function() {
		...
		$(function() {
			$("#shared_folder_move_dialog").dialog({
				autoOpen : false,
				width : 300,
				height : 400,
				show: {
		...
		$(".folder_move_button").click(function() {
			
			$("#folderMoveTree").jstree({ 
				"core":{
					"animation" : 200
				},
				"json_data" : {
			...
			$("#folder_move_dialog").dialog("open");
		});
		$(".shared_folder_move_button").click(function() {
			
			$("#folderMoveTree2").jstree({ 
				"core":{
					"animation" : 200
				},
				"json_data" : {
			...
			$("#shared_folder_move_dialog").dialog("open");
		});
	});
</script>
<body>
<div id="folder_move_dialog" title="폴더 이동" style='display: none;'>
	<div id='folderMoveTree' class='jstree-corral' >
	</div>
</div>

<div id="shared_folder_move_dialog" title="공유 폴더 이동" style='display: none;'>
	<div id='folderMoveTree2' class='jstree-corral' >
	</div>
</div>
